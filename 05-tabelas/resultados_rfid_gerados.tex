...
\begin{table}[htbp]
    ...
    \begin{tabular}{lcccc}
        ...
        Plástico & 5/5 & 100,0\% & 56,6\% a 100,0\% & 180,6 $\pm$ 0,9 \\
        Madeira & 5/5 & 100,0\% & 56,6\% a 100,0\% & 174,4 $\pm$ 6,8 \\
        Vidro & 3/5 & 60,0\% & 23,1\% a 88,2\% & 181,7 $\pm$ 7,1 \\
        Metal direto & 0/5 & 0,0\% & 0,0\% a 43,4\% & Sem leitura \\
        Metal com espaçador & 5/5 & 100,0\% & 56,6\% a 100,0\% & 180,6 $\pm$ 5,9 \\
        \bottomrule
    \end{tabular}
    \fonte{Elaborado pelo autor a partir dos dados experimentais (2026).}
\end{table}%
