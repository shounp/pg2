...
O datasheet classifica a AD-239 M730 como solução para superfícies não metálicas. No ensaio específico de material, o mesmo exemplar TAG1 foi avaliado sobre papelão, plástico, madeira, vidro, metal direto e metal separado por um espaçador plástico de 10~mm. O uso do mesmo exemplar reduz a variação entre etiquetas dentro desse bloco, mas limita a generalização para outros exemplares e geometrias de aplicação. Nos ensaios de distância e orientação, papelão, madeira e plástico permaneceram associados, respectivamente, a TAG1, TAG2 e TAG3; por isso, esses suportes não foram avaliados como fatores independentes nesses dois blocos. A \autoref{tab:ad239m730} reúne as especificações relevantes para esse recorte.
