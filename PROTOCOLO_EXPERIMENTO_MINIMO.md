...
1. Use preferencialmente fonte externa regulada de 5 V, mantenha GND comum e
   confira as conexões. Se também testar a alimentação USB do Arduino, registre
   a fonte usada em cada tentativa para permitir comparação posterior.
...
- Execute cinco janelas de 25 segundos.
