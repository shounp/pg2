...
\begin{siglas}
    ...
    \item[EIRP] \textit{Equivalent Isotropically Radiated Power} (potência isotrópica radiada equivalente)
    \item[EPC] \textit{Electronic Product Code}
    \item[FHSS] \textit{Frequency-Hopping Spread Spectrum} (espalhamento espectral por salto de frequência)
